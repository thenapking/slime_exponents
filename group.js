...
function create_groups(){
  ...
  groups.push(new Group(1, palette.colours[palette.strokes[2]], palette.colours[palette.strokes[2]], 0.25, 15, 0.35, 0.68, 60, 160, 6, 1));
  groups.push(new Group(2, palette.colours[palette.strokes[3]], palette.colours[palette.strokes[3]], 3.50, 50, 0.07, 0.14, 6, 150, 12, 2));
  groups.push(new Group(3, palette.colours[palette.strokes[1]], palette.colours[palette.strokes[1]], 3.50, 50, 0.07, 0.14, 6, 150, 12, 2));
